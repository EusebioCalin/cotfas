      ...
      <div className='grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5'>
        <div className='lg:col-span-2'>
          <div>
            ...
            <Link
              href='/'
              className='flex items-center space-x-2 text-2xl font-medium text-white hover:text-red-600'
            >
        ...
        <div className=''>
          <div>Social</div>
          <div className='flex mt-5 space-x-5 text-white hover:text-red-600'>
