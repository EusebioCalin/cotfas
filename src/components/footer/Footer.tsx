...
export default function Footer() {
  ...
  return (
    <div className='relative'>
      <div className='grid max-w-full grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-4'>
        <div className=''>
          <div>
            {' '}
            <Link
              href='/'
              className='flex items-center justify-center space-x-2 text-2xl md:pl-4 font-medium text-white hover:text-red-600'
            >
        ...
        <div>
          <div className='flex justify-center flex-wrap w-full -mt-2 -ml-3 lg:ml-0'>
        ...
        <div className=''>
          <div className='flex justify-center'>Social</div>
          <div className='flex mt-5 space-x-5 text-white hover:text-red-600 justify-center'>
      ...
      <div className='my-10 text-sm text-center text-white hover:text-red-600'>
